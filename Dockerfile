# this will publish ports of haproxy 16379 and the node > tor proxies for out side docker 15379 ... 
FROM alpine:latest
...
# install multitor
RUN	git clone https://github.com/geminigeek/multi-tor-tunnel multitor && \
	cd multitor && \
	./setup.sh install && \
# create log folders
