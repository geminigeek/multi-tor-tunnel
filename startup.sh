...
multitor --init $TOR_INSTANCE_COUNT --user root --socks-port 9000 --control-port 9900 --proxy hpts --haproxy --verbose --debug > /tmp/multitor.log; tail -f /tmp/multitor.log